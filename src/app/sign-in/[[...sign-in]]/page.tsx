...
export default function Page() {
  return (
    <div className="min-h-screen bg-[#06070B] flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-[500px] h-[500px] bg-[#6C47FF]/10 blur-[120px] rounded-full pointer-events-none" />
      <div className="absolute bottom-[-10%] right-[-10%] w-[500px] h-[500px] bg-[#EC4899]/10 blur-[120px] rounded-full pointer-events-none" />
      ...
      <div className="mb-12 relative z-10 flex flex-col items-center gap-4">
        ...
        <p className="text-white/20 text-xs font-black uppercase tracking-[0.3em]">Neural Access Node</p>
      </div>
